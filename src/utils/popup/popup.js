...
export const IncorrectPasswordPopup = new Popup({
	id: 'disclaimer',
	title: 'Incorrect Password.',
	content: 'it seems you\'ve entered an incorrect password',
  titleColor: '#fff',
  textColor: '#fff',
  backgroundColor: '#222',
  borderColor: '#fff',
...
export const UserNotFoundPopup = new Popup({
	id: 'disclaimer',
	title: 'User Not Found.',
	content: 'No user associated with this email was found',
  titleColor: '#fff',
  textColor: '#fff',
  backgroundColor: '#222',
  borderColor: '#fff',
...
export const NetworkErrorPopup = new Popup({
  id: 'disclaimer',
  title: 'Network Error.',
...
export const EmailInUsePopup = new Popup({
  id: 'disclaimer',
...
export const SignupErrorPopup = new Popup({
  id: 'disclaimer',
  title: 'Cannot Create User.',
  content: 'User creation encountered an error',
  titleColor: '#fff',
  textColor: '#fff',
  backgroundColor: '#222',
  borderColor: '#fff',
...
export const ProductCardPopup = new Popup({
      id: 'disclaimer',
      title: "You're Not Signed In",
      content: `Please {a-/auth}[Sign In] to add items to your cart.`,
      titleColor: '#fff',
      textColor: '#fff',
      backgroundColor: '#222',
      borderColor: '#fff',
...
export const CartIconPopup = new Popup({
  id: 'disclaimer',
  title: "You're Not Signed In",
  content: `Please {a-/auth}[Sign In] to see your cart items.`,
  titleColor: '#fff',
  textColor: '#fff',
  backgroundColor: '#222',
  borderColor: '#fff',
